...
interface ClientCasesListProps {
  ...
  onManageParalegals?: () => void
}

export default function ClientCasesList({ refreshTrigger, onEdit, onManageParalegals }: ClientCasesListProps) {
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          {filteredCases.length > 0 && (
            <div className="flex items-center gap-3">
              ...
              {onManageParalegals && (
                <button
                  onClick={onManageParalegals}
                  className="flex items-center gap-2 px-3 py-1.5 text-sm bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200 transition-colors border"
                  title="Manage Paralegals"
                >
